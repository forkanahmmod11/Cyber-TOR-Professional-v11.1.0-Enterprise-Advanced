# Cyber Tor Enterprise — Access & Delivery

## Access model
Cyber Tor is a local/Linux-oriented assessment toolkit. The current package does **not** claim to provide a built-in enterprise user-account, RBAC, SSO, or SaaS authentication system.
