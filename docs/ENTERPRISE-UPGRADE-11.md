# Cyber TOR Professional v11.0.0 — Enterprise Upgrade
...
```bash
./cyber-tor enterprise-center
./cyber-tor enterprise-assets --target https://example.com --criticality 80
./cyber-tor enterprise-risk --target https://example.com
./cyber-tor enterprise-compliance --target https://example.com
./cyber-tor secret-scan ./project
./cyber-tor container-audit ./project
./cyber-tor evidence-seal
./cyber-tor vuln-feed-import ./vulnerability-feed.json
./cyber-tor schedule https://example.com enterprise-deep-analysis "daily"
```
...
1. Start `./cyber-tor admin-panel` (or the existing admin-panel command).
